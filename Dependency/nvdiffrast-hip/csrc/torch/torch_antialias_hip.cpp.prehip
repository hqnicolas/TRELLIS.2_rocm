...
#include "../common/antialias_hip.h"
...
{
    const at::hip::OptionalHIPGuardMasqueradingAsCUDA device_guard(device_of(tri));
...
{
    const at::hip::OptionalHIPGuardMasqueradingAsCUDA device_guard(device_of(color));
    hipStream_t stream = at::hip::getCurrentHIPStreamMasqueradingAsCUDA();
    AntialiasKernelParams p = {}; // Initialize all fields to zero.
